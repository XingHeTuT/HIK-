...
D_stop_mm = 2*2.229883854002862E+001; 
...
% --- Zemax 理想系数 ---
radius_norm_mm = 1.0; 
A_coeffs_ideal = [-6.997009396221000E-001, 2.348196150610000E-002, -5.843441019780000E-005, 1.710922628720000E-007, ...
    -5.595086467372000E-010, 1.958731108620000E-012, -7.106302567436001E-015, 2.459255032029000E-017, -5.898848142976000E-020];

max_iter = 100;
% 请修改为您存放 xlsx 文件的文件夹路径
dataFolder = 'D:\LiLinhan_2025\相位反演\球超离焦还原_论文版\Zemax_Sim\Zemax_xlsx'; 
